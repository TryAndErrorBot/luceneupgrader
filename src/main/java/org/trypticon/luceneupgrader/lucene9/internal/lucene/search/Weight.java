 ...
 *
 * <p>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.index.LeafReader} dependent state should reside in the {@link
 * Scorer}.
 *
 * <p>Since {@link Weight} creates {@link Scorer} instances for a given {@link
 * LeafReaderContext} ({@link
 * #scorer(LeafReaderContext)}) callers must maintain the relationship
