...
import org.trypticon.luceneupgrader.lucene9.internal.lucene.document.DocumentStoredFieldVisitor;
...
public final class CheckIndex implements Closeable {
   ...
   *
   * <pre>
   * java -ea:org.trypticon.luceneupgrader.lucene9.internal.lucene... org.trypticon.luceneupgrader.lucene9.internal.lucene.index.CheckIndex pathToIndex [-exorcise] [-verbose] [-segment X] [-segment Y]
   * </pre>
   *
   * <ul>
  ...
  private static int doMain(String[] args) throws IOException, InterruptedException {
    ...
    if (!assertsOn())
      System.out.println(
          "\nNOTE: testing will be more thorough if you run java with '-ea:org.trypticon.luceneupgrader.lucene9.internal.lucene...', so assertions are enabled");
    ...
    if (opts.indexPath == null) {
      throw new IllegalArgumentException(
          "\nERROR: index path not specified"
              + "\nUsage: java org.trypticon.luceneupgrader.lucene9.internal.lucene.index.CheckIndex pathToIndex [-exorcise] [-slow] [-segment X] [-segment Y] [-threadCount X] [-dir-impl X]\n"
              + "\n"
