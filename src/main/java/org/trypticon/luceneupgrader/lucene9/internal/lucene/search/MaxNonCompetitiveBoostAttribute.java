...
/**
 * Add this {@link Attribute} to a fresh {@link AttributeSource} before calling {@link
 * MultiTermQuery#getTermsEnum(Terms,AttributeSource)}. {@link FuzzyQuery} is using this to control
 ...
 * MultiTermQuery.RewriteMethod} to an empty {@link AttributeSource} that is shared for all segments
 * during query rewrite. This attribute source is passed to all segment enums on {@link
 * MultiTermQuery#getTermsEnum(Terms,AttributeSource)}. {@link TopTermsRewrite} uses this attribute
