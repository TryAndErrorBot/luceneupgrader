...
import org.trypticon.luceneupgrader.lucene9.internal.lucene.search.ReferenceManager;
import org.trypticon.luceneupgrader.lucene9.internal.lucene.search.SearcherManager;
import org.trypticon.luceneupgrader.lucene9.internal.lucene.store.Directory;

import java.io.IOException;

/**
 * Utility class to safely share {@link DirectoryReader} instances across multiple threads, while
...
public final class ReaderManager extends ReferenceManager<DirectoryReader> {
  ...
  /**
   * Expert: creates and returns a new ReaderManager from the given {@link IndexWriter}, controlling
   ...
   * @throws IOException If there is a low-level I/O error
   */
  public ReaderManager(IndexWriter writer, boolean applyAllDeletes, boolean writeAllDeletes)
      throws IOException {
