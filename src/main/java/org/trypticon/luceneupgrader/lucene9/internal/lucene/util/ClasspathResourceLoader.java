 ...
 * contain resources to the {@code org.trypticon.luceneupgrader.lucene9.internal.lucene.core} module, otherwise resources can't be
    ...
    if (stream == null) {
      throw new IOException(
          "Resource not found (if you use Java Module System, make sure to open "
              + "module and package containing resources to 'org.trypticon.luceneupgrader.lucene9.internal.lucene.core' module): "
              + resource);
    }
    return stream;
  }
