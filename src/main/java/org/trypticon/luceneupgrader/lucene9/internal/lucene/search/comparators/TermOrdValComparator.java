 ...
 * {@link org.trypticon.luceneupgrader.lucene9.internal.lucene.search.FieldComparator.TermValComparator}, but it first resolves the
 * string to their relative ordinal positions (using the index returned by {@link
 * org.trypticon.luceneupgrader.lucene9.internal.lucene.index.LeafReader#getSortedDocValues(String)}), and does most comparisons using
 * the ordinals. For medium to large results, this comparator will be much faster than {@link
 * org.trypticon.luceneupgrader.lucene9.internal.lucene.search.FieldComparator.TermValComparator}. For very small result sets it may be
 * slower.
 */
