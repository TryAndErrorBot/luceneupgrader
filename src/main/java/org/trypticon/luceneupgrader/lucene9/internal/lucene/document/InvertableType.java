...
public enum InvertableType {
   ...
   * IndexableField#tokenStream(org.trypticon.luceneupgrader.lucene9.internal.lucene.analysis.Analyzer,
   * org.trypticon.luceneupgrader.lucene9.internal.lucene.analysis.TokenStream)}.
   */
  TOKEN_STREAM;
}
