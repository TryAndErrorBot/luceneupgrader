 ...
 */
package org.trypticon.luceneupgrader.lucene9.internal.lucene.codecs.lucene60;
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    try {
                        infos[i] = new FieldInfo(name, fieldNumber, storeTermVector, omitNorms, storePayloads,
                                ...
                                pointDataDimensionCount, pointIndexDimensionCount, pointNumBytes, vectorDimension,
                                vectorEncoding, vectorDistFunc, isSoftDeletesField);
