 ...
 * footprint.
 *
 * <p>The main access point is the {@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedInts} factory.
 *
 * <h2>In-memory structures</h2>
 *
 * <ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedInts.Mutable}</b>
 *       <ul>
 ...
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.GrowableWriter}</b>
 *       <ul>
 ...
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PagedGrowableWriter}</b>
 *       <ul>
 ...
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedLongValues#deltaPackedBuilder}</b>
 *       <ul>
 ...
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedLongValues#packedBuilder}</b>
 *       <ul>
 *         <li>Same as deltaPackedBuilder but assumes values are 0-based.
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedLongValues#monotonicBuilder}</b>
 *       <ul>
 ...
 *
 * <ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedInts.Writer}, {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedInts.Reader}, {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedInts.ReaderIterator}</b>
 *       <ul>
 *         <li>Only supports positive longs.
 *         <li>Requires the number of bits per value to be known in advance.
 ...
 *             Reader.
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.BlockPackedWriter}, {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.BlockPackedReaderIterator}</b>
 *       <ul>
 *         <li>Splits the stream into fixed-size blocks.
 *         <li>Compression is good when values are close to each other.
 *         <li>Can address up to 2B * blockSize values.
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.MonotonicBlockPackedWriter}, {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.MonotonicBlockPackedReader}</b>
 *       <ul>
 ...
 *       </ul>
 *   <li><b>{@link org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedDataOutput}, {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.util.packed.PackedDataInput}</b>
 *       <ul>
