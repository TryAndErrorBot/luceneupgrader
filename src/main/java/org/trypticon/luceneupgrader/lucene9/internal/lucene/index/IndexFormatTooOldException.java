...
public class IndexFormatTooOldException extends IOException {
   ...
   * @lucene.internal
   */
  public IndexFormatTooOldException(
      String resourceDescription, int version, int minVersion, int maxVersion) {
    super(
        "Format version is not supported (resource "
            + resourceDescription
            + "): "
  ...
  /**
   * Returns the version of the file that was too old. This method will return <code>null</code> if
   * an alternative {@link #getReason()} is provided.
   */
  ...
  /**
   * Returns the maximum version accepted. This method will return <code>null</code> if an
   * alternative {@link #getReason()} is provided.
   */
  ...
  /**
   * Returns the minimum version accepted This method will return <code>null</code> if an
   * alternative {@link #getReason()} is provided.
   */
