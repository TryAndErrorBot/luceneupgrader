...
import org.trypticon.luceneupgrader.lucene9.internal.lucene.util.SmallFloat;
 ...
 *       efficient). The default computation for <i>tf(t in d)</i> in {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.search.similarities.ClassicSimilarity#tf(float) ClassicSimilarity} is:
 *       <br>
 *       &nbsp;<br>
 *       <table class="padding2" style="border-spacing: 2px; border-collapse: separate; border: 0; width:auto; margin-left:auto; margin-right:auto">
 ...
 *        <tr>
 *          <td style="vertical-align: middle; text-align: right" rowspan="1">
 *            {@link org.trypticon.luceneupgrader.lucene9.internal.lucene.search.similarities.ClassicSimilarity#tf(float) tf(t in d)} &nbsp; = &nbsp;
 *          </td>
 ...
 *       in the equation. The default computation for <i>idf(t)</i> in {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.search.similarities.ClassicSimilarity#idf(long, long) ClassicSimilarity}
 *       is: <br>
 *       &nbsp;<br>
 *       <table class="padding2" style="border-spacing: 2px; border-collapse: separate; border: 0; width:auto; margin-left:auto; margin-right:auto">
 ...
 *            {@link org.trypticon.luceneupgrader.lucene9.internal.lucene.search.similarities.ClassicSimilarity#idf(long, long) idf(t)}&nbsp; = &nbsp;
 *          </td>
 *          <td style="vertical-align: middle; text-align: center">
 ...
 *       syntax</A>), or as set by wrapping with {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.search.BoostQuery#BoostQuery(org.trypticon.luceneupgrader.lucene9.internal.lucene.search.Query, float)
 *       BoostQuery}. Notice that there is really no direct API for accessing a boost of one term in
 *       a multi term query, but rather multi terms are represented in a query as multi {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.search.TermQuery TermQuery} objects, and so the boost of a term in the
 *       query is accessible by calling the sub-query {@link
 *       org.trypticon.luceneupgrader.lucene9.internal.lucene.search.BoostQuery#getBoost() getBoost()}. <br>
 *       &nbsp;<br>
 ...
 * </ol>
 *
 * @see org.trypticon.luceneupgrader.lucene9.internal.lucene.index.IndexWriterConfig#setSimilarity(Similarity)
...
public abstract class TFIDFSimilarity extends Similarity {
   ...
   * org.trypticon.luceneupgrader.lucene9.internal.lucene.index.IndexReader#numDocs() IndexReader#numDocs()} because also {@link
