...
public class MMapDirectory extends FSDirectory {
   ...
   * -Dorg.trypticon.luceneupgrader.lucene9.internal.lucene.store.MMapDirectory.enableUnmapHack=false} to disable.
   *
   * @lucene.internal
   */
  public static final String ENABLE_UNMAP_HACK_SYSPROP =
      "org.trypticon.luceneupgrader.lucene9.internal.lucene.store.MMapDirectory.enableUnmapHack";
   ...
   * -Dorg.trypticon.luceneupgrader.lucene9.internal.lucene.store.MMapDirectory.enableMemorySegments=false} to disable.
   *
   * @lucene.internal
   */
  public static final String ENABLE_MEMORY_SEGMENTS_SYSPROP =
      "org.trypticon.luceneupgrader.lucene9.internal.lucene.store.MMapDirectory.enableMemorySegments";
